...
import { FaDiscord, FaFacebook, FaInstagram, FaLinkedin, FaTwitch, FaTwitter } from "react-icons/fa";
      ...
      <div className="container mx-auto flex flex-col items-center justify-between gap-4 px-8 md:flex-row">
        ...
        <div className="flex justify-center gap-4 md:justify-start">
            {links.map((link) => (
                ...
                className="text-black transition-all duration-300 hover:text-white">
            {link.icon}
                </a>
            ))}
        </div>
